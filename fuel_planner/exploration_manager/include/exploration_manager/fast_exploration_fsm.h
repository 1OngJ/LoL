...
enum EXPL_STATE { INIT, WAIT_TRIGGER, ROTATING ,PLAN_TRAJ, PUB_TRAJ, EXEC_TRAJ, FINISH };
...
private:
  ...
  bool classic_;
  std_msgs::Bool explorefinish;

  /* ROS utils */
  ros::NodeHandle node_;
  ros::Timer exec_timer_, safety_timer_, vis_timer_, frontier_timer_;
  ros::Subscriber trigger_sub_, odom_sub_;
  ros::Publisher replan_pub_, new_pub_, bspline_pub_,viewpoint_pub_,finish_pub;
